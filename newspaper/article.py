    ...
    def set_reddit_top_img(self):
        ...
        try:
            ...
            if "Can't convert 'NoneType' object to str implicitly" in e.args[0]:
                ...
                log.debug('TypeError other than None type error. Cannot set top image using the Reddit algorithm. Possible error with PIL., %s' % e)
        except Exception as e:
            log.debug('Other error with setting top image using the Reddit algorithm. Possible error with PIL, %s' % e)
